                            ...
                            <div class="panel-body" id="formularioRegistros">
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label>Fecha(*) : </label>
                                        <input type="date" class="form-control" name="fhIngreso" id="fhIngreso" required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Tipo Comprobante(*) : </label>
                                        <select class="form-control selectpicker" name="tcIngreso" id="tcIngreso">
                                    ...
                                    <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                        <label>Serie(*) : </label>
                                        <input type="text" class="form-control" name="scIngreso" id="scIngreso" maxlength="7" placeholder="Serie" required>
                                    </div>
                                    <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                        <label>Numero(*) : </label>
                                        <input type="text" class="form-control" name="ncIngreso" id="ncIngreso" maxlength="10" placeholder="Numero" required>
                                    </div>
                                    <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                        <label>Impuesto(*) : </label>
                                        <input type="text" class="form-control" name="impIngreso" id="impIngreso" required>
                                    </div>
